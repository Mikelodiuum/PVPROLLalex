...
# Fantasma: la bala sólo puede atraversar la pared una vez perdiendo mitad de su daño
...
func _physics_process(delta):
	...
	for body in overlapping:
		...
		if body != shooter and body.has_method("take_damage") and not hit_targets.has(body):
			...
			# --- Azar: probabilidad de doble daño por bala ---
			...
			# --- Veneno: delegar al objetivo para que maneje su propio veneno ---
